...
local gmi_output = page.get_output("N. IN. NWS Area Forecast Discussion")
local output_filename =  config.get_value_for("gmidir") .. config.get_value_for("wx_nind_discussion_output_file")
