...
local gmi_output = page.get_output("Airport Conditions")

local output_filename =  config.get_value_for("gmidir") .. config.get_value_for("wx_conditions_output_file")
...
local text_output_filename =  config.get_value_for("gmidir") .. "current-conditions.txt"
