...
bindir=/home/gemini/toledoweather/GeminiToledoWXLua/bin
errfile=/home/gemini/toledoweather/log/error.txt
...
echo flash briefing
$bindir/fetch-flash-briefing-gmi.lua > /home/gemini/docroot/tolwx/briefing.gmi  2>> $errfile
