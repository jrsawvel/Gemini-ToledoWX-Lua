...
local gmi_output = page.get_output("Cle NWS Area Forecast Discussion")
local output_filename =  config.get_value_for("gmidir") .. config.get_value_for("wx_discussion_output_file")
